    ...
    var body: some View {
        VStack {
            ...
            Button("Save") {
                ...
                taskModel.updateTask(task: Task(title: title,description: description, isCompleted: details.isCompleted))
                dismiss()
...
#Preview {
    EditTaskView(details: Task(title: "string", description: "String", isCompleted: true))
}
